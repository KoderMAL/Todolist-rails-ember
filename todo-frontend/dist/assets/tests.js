...
define('todo-frontend/tests/lint/app.lint-test', [], function () {
  'use strict';
...
define('todo-frontend/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('todo-frontend/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'todo-frontend/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('todo-frontend/templates/components/todo-list.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-frontend/templates/components/todo-list.hbs should pass TemplateLint.\n\ntodo-frontend/templates/components/todo-list.hbs\n  4:14  error  Incorrect indentation of attribute \'type\' beginning at L4:C14. Expected \'type\' to be at L5:C8.  attribute-indentation\n  4:26  error  Incorrect indentation of attribute \'class\' beginning at L4:C26. Expected \'class\' to be at L6:C8.  attribute-indentation\n  4:56  error  Incorrect indentation of attribute \'name\' beginning at L4:C56. Expected \'name\' to be at L7:C8.  attribute-indentation\n  4:68  error  Incorrect indentation of attribute \'value\' beginning at L4:C68. Expected \'value\' to be at L8:C8.  attribute-indentation\n  4:86  error  Incorrect indentation of attribute \'enter\' beginning at L4:C86. Expected \'enter\' to be at L9:C8.  attribute-indentation\n  4:119  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L4:C119. Expected \'{{input}}\' to be at L10:C6.  attribute-indentation\n  17:12  error  Incorrect indentation of htmlAttribute \'class\' beginning at L17:C12. Expected \'class\' to be at L18:C8.  attribute-indentation\n  17:70  error  Incorrect indentation of element modifier \'action\' beginning at L17:C70. Expected \'action\' to be at L19:C8.  attribute-indentation\n  17:92  error  Incorrect indentation of close bracket \'>\' for the element \'<span>\' beginning at L17:C92. Expected \'<span>\' to be at L20:C6.  attribute-indentation\n  17:97  error  Incorrect indentation of close tag \'</span>\' for element \'<span>\' beginning at L17:C97. Expected \'</span>\' to be at L17:C6.  attribute-indentation\n  5:44  error  Interaction added to non-interactive element  no-invalid-interactive\n  6:45  error  Interaction added to non-interactive element  no-invalid-interactive\n  17:70  error  Interaction added to non-interactive element  no-invalid-interactive\n  18:37  error  Interaction added to non-interactive element  no-invalid-interactive\n  4:100  error  you must use double quotes in templates  quotes\n  11:65  error  you must use double quotes in templates  quotes\n  17:79  error  you must use double quotes in templates  quotes\n');
  });

  QUnit.test('todo-frontend/templates/todo.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-frontend/templates/todo.hbs should pass TemplateLint.\n\ntodo-frontend/templates/todo.hbs\n  11:14  error  Incorrect indentation of attribute \'class\' beginning at L11:C14. Expected \'class\' to be at L12:C8.  attribute-indentation\n  11:28  error  Incorrect indentation of attribute \'name\' beginning at L11:C28. Expected \'name\' to be at L13:C8.  attribute-indentation\n  11:40  error  Incorrect indentation of attribute \'value\' beginning at L11:C40. Expected \'value\' to be at L14:C8.  attribute-indentation\n  11:51  error  Incorrect indentation of attribute \'placeholder\' beginning at L11:C51. Expected \'placeholder\' to be at L15:C8.  attribute-indentation\n  11:81  error  Incorrect indentation of attribute \'autofocus\' beginning at L11:C81. Expected \'autofocus\' to be at L16:C8.  attribute-indentation\n  11:97  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L11:C97. Expected \'{{input}}\' to be at L17:C6.  attribute-indentation\n');
  });
});
define('todo-frontend/tests/lint/tests.lint-test', [], function () {
  'use strict';
...
define('todo-frontend/tests/test-helper', ['todo-frontend/app', 'todo-frontend/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('todo-frontend/tests/unit/routes/todos-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
require('todo-frontend/tests/test-helper');
